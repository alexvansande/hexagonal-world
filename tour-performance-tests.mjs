...
const budgets={routes:70,samples:32000,paths:420,projectMs:700,pathMs:120};
...
for(const name of ['tour-migrations.mjs','tour-vinland.mjs','tour-polynesia.mjs','tour-americas.mjs','tour-africa.mjs','tour-oceans.mjs','tour-trade-periods.mjs','tour-periods.mjs','tour-trade-traffic.mjs']){
...
const app=await readFile('dist/app.mjs','utf8');assert(!/from '\.\/tour-(migrations|vinland|polynesia|americas|africa|oceans|trade-periods)\.mjs/.test(app));
