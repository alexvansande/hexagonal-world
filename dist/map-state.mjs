import {reliefRanges} from './relief.mjs?v=cloud-assets-1';
...
const stateKeys=['method','arrangement','lon','lat','roll','bias','height','gridRotation','grid','line','clearance','distortionOpacity','mode',...reliefRanges.map(s=>s[0]),'riverWidth','riverLevels','sidebarExpanded','subgridWidth','graticuleWidth','shadowOpacity','lightOpacity','puzzleWidth','backdropWidth','backdropOpacity','routeDotSize','routeTail','routeLineWidth','labelScale'];
const controlKeys=['map-source','land-classes','ocean-classes','interpolation','graticule','subgrid','dotgrid','construction','labels','distortion','palette','indicatrix','terrain','quality','optimize','ecology-rivers','relief-enabled','relief-material','relief-treatment','relief-tone','rivers-visible','background-color','border-color','hex-grid-color','graticule-color','fractalgrid','lighting-preset','river-color','puzzlegrid','puzzle-count','puzzle-color','backdrop-grid','backdrop-color','motion','dance','route-style','route-motion','marker-ripples'];
