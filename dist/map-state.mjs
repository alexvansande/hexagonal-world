...
const stateKeys=['method','arrangement','lon','lat','roll','bias','height','gridRotation','grid','line','clearance','distortionOpacity','mode',...reliefRanges.map(s=>s[0]),'riverWidth','riverLevels','sidebarExpanded','subgridWidth','graticuleWidth'];
const controlKeys=['map-source','land-classes','ocean-classes','interpolation','graticule','subgrid','dotgrid','construction','labels','distortion','palette','indicatrix','terrain','quality','optimize','ecology-rivers','relief-enabled','relief-material','relief-treatment','relief-tone','rivers-visible','background-color','border-color','hex-grid-color','graticule-color','fractalgrid'];
