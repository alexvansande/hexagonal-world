...
assert.equal(byId.lifezones.controls.subgrid,true);assert.equal(byId.lifezones.controls.dotgrid,true);assert.equal(byId.lifezones.state.subgridWidth,.2);assert.equal(byId.lifezones.controls['hex-grid-color'],'#d6d6d6');assert.equal(byId.lifezones.controls['background-color'],'#d9d3d3');
