...
for(const name of ['tour-trade-periods.mjs','tour-trade.mjs','tour-trade-regions.mjs','tour-route-data.mjs','tour-area-data.mjs','tour-migrations.mjs'])assert(!seen.has(resolve('dist',name)),name+' must not be eagerly imported');
