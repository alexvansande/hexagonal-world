...
import {africaChapters} from './tour-africa.mjs?v=strands-2';
...
export const tourChapters={'silk-road':{heading:tradeHeading,periods:tradePeriods,periodFor:tradePeriod},'origin-of-mankind':migrationChapters,'iceland-to-vinland':vinlandChapters,'french-polynesia':polynesiaChapters,'americas-exchange':americasChapters,'african-networks':africaChapters,'ocean-crossings':oceanChapters};
