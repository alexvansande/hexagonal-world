...
export const timelineStops=Object.freeze([
 ...
 {id:'antiquity',label:'Antiquity',date:'c. 200 CE',year:200,chapters:[chapter('silk-road','antiquity'),chapter('americas-exchange','classic')]},
 ...
 {id:'high-middle-ages',label:'High Middle Ages',date:'c. 1300 CE',year:1300,chapters:[chapter('silk-road','high-middle-ages'),chapter('french-polynesia','far-corners'),chapter('french-polynesia','south-america'),chapter('iceland-to-vinland','north-atlantic',['trade'])]},
 {id:'globalization',label:'Globalization',date:'c. 1450–1520 CE',year:1450,chapters:[chapter('americas-exchange','late-precolumbian')],note:'Zheng He, the Iberian voyages and the Indian Ocean trade are not written yet.'},
 {id:'plantations-and-empires',label:'Plantations & empires',date:'c. 1750 CE',year:1750,chapters:[],note:'The Atlantic slave trade, colonization, the Manila galleon and silver flows are not written yet.'},
