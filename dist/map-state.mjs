...
const stateKeys=['method','arrangement','lon','lat','roll','bias','height','gridRotation','grid','line','clearance','distortionOpacity','mode',...reliefRanges.map(s=>s[0]),'riverWidth','riverLevels','sidebarExpanded','subgridWidth','graticuleWidth','shadowOpacity','lightOpacity','puzzleWidth'];
