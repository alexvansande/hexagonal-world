...
export const layoutOptions=[
 {name:'Spaceship Earth',arrangement:'dymaxion',state:{method:'rhombic',arrangement:'dymaxion',lon:-170.01889457926154,lat:32.99273576349003,roll:-13.384930707514286,bias:1,height:1.5,clearance:0,gridRotation:30},controls:{'backdrop-grid':true,interpolation:'0',optimize:false}},
 {name:'Felv',arrangement:'felv',state:{method:'rhombic',arrangement:'felv',lon:5.190924769634733,lat:-36.21205325030689,roll:2.3232274432430753,bias:1,height:1.5,clearance:3,gridRotation:0},controls:{'backdrop-grid':false,interpolation:'0',optimize:false}},
 {name:'Flower World',arrangement:'bighex',state:{method:'rhombic',arrangement:'bighex',lon:-19.196120097618845,lat:54.98466622358542,roll:-73.21086442098823,bias:1,height:1.5,gridRotation:60},controls:{'backdrop-grid':false,interpolation:'0',optimize:false}},
 {name:'Gosper Fractal',arrangement:'gosper',state:{method:'rhombic',arrangement:'gosper',lon:-19.196120097618845,lat:54.98466622358542,roll:-73.21086442098823,bias:1,height:1.5,gridRotation:60},controls:{'backdrop-grid':false,interpolation:'0',optimize:false}},
 {name:'4Hexes',arrangement:'flower',state:{method:'rhombic',arrangement:'flower',lon:132.47383515760305,lat:40.19079148977437,roll:87.45012620687487,bias:1,height:1.5,clearance:1,gridRotation:120},controls:{'backdrop-grid':false,interpolation:'0',optimize:false}},
 {name:'Infinite Honeycomb',arrangement:'infinite',state:{method:'rhombic',arrangement:'infinite',lon:-168.51360216723162,lat:37.41313981522221,roll:-11.453856794719924,bias:1,height:1.5,clearance:1,gridRotation:60},viewOffset:[-0.28669960461805105,-0.4522765322383842],controls:{interpolation:'0',optimize:false}},
 {name:'Rus One',arrangement:'single',state:{method:'lambert-one',arrangement:'single',lon:0,lat:0,roll:0,bias:1,height:1.5,clearance:0,gridRotation:30},controls:{'backdrop-grid':false,interpolation:'0',optimize:false}},
 {name:'Rus Two',arrangement:'double',state:{method:'lambert-two',arrangement:'double',lon:-21.47927481028223,lat:-2.7086501277338852,roll:101.53366955475948,bias:1,height:1.5,clearance:0,gridRotation:30},controls:{'backdrop-grid':false,interpolation:'0',optimize:false}}
];
...
export const styleOptions=[
  ...
  },
  {
    ...
    "controls": {
      ...
      "indicatrix": "off",
      "border-color": "#ffffff",
      "hex-grid-color": "#ffffff",
      "graticule-color": "#4f8796",
      "background-color": "#cedbde"
    },
    "thumbnail": "maps/styles/topographic.png"
  },
  {
    "id": "political",
    "name": "Political",
