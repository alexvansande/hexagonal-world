...
import {ecologyGridGLSL,ecologyBridgeGLSL} from './ecology-grid.mjs?v=bridges-12';
...
import {mapSource,landLegends,oceanLegend,missing,riverMask} from './map-layers.mjs?v=neighbor-filled-1-waves-1';
...
const hexBridgesEnabled=hexBridgeMode==='0'?0:hexBridgeMode==='5'?5:hexBridgeMode==='4'?4:hexBridgeMode==='3'?3:hexBridgeMode==='2'?2:1;
