...
import {ecologyGridGLSL,ecologyBridgeGLSL} from './ecology-grid.mjs?v=bridges-6';
...
import {mapSource,landLegends,oceanLegend,missing,riverMask} from './map-layers.mjs?v=missing-land-1-waves-1';
