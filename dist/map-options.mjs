...
export const layoutOptions=[
 ...
 {name:'Felv',arrangement:'felv',state:{method:'rhombic',arrangement:'felv',lon:-5.183258477970867,lat:-42.04019961295529,roll:-1.7428079310803923,bias:1,height:1.5,clearance:3,gridRotation:0},controls:{interpolation:'0',optimize:false}},
 ...
 {name:'Rus One',arrangement:'single',state:{method:'lambert-one',arrangement:'single',lon:0,lat:0,roll:0,bias:1,height:1.5,clearance:0,gridRotation:30},controls:{interpolation:'0',optimize:false}},
 {name:'Rus Two',arrangement:'double',state:{method:'lambert-two',arrangement:'double',lon:-21.47927481028223,lat:-2.7086501277338852,roll:101.53366955475948,bias:1,height:1.5,clearance:0,gridRotation:30},controls:{interpolation:'0',optimize:false}}
];
